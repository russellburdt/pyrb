...
- percentage of vehicle evals with any individual behavior
- average count of individual behaviors for vehicle evals
behavior analysis metrics, with ML
- logistic regression and random forest models
- model and permutation feature importance
"""
