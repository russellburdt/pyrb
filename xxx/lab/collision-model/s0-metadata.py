...
# model params
population = 'dft'
time0, time1 = '6/1/2023', '10/2/2023'
predictor_interval_days, collision_interval_days = 90, 30
...
dt = utils.collision_prediction_model_windows(time0=time0, time1=time1, predictor_interval_days=predictor_interval_days, collision_interval_days='calendar-month', overlap_days='calendar-month')
